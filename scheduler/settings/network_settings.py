class NetworkSettings:
    ...
    EXTERNAL_REQUEST_MODE = False # Allow sending external requests to random node
    EXTERNAL_REQUEST_TOTAL_REQUESTS_NUMBER = 0 # Limit of created external requests. If none the number is unlimited
    NUMBER_OF_REQUESTS = [0] # List of numbers of requests created in one time
